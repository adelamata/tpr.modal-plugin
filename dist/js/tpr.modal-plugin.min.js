...
a._attachEvent(a.$modal.$modalmorelbtn,"click",function(){a.$modal.$modalmorebox.slideToggle()}));a.$modal.$modalbox.append(a.$modal.$modaltopbar);a.$modal.$modalbox.append(a.$modal.$modalcontent);a.$modal.$modalbox.append(a.$modal.$modalbotbar);var b=f.innerWidth,d=f.innerHeight,e=Math.floor(a.$modal.$modalbox.innerWidth()/100*b),g=Math.floor(a.$modal.$modalbox.innerHeight()/100*d)+400;a.$modal.$modalbox.css({left:b/2-e/2+"px",top:d/2-g/2+"px"});a.options.backlayer?(a.$modal.$modalbackground.appendTo(c("body")),
a.$modal.$modalbox.appendTo(a.$modal.$modalbackground),a.options.closeoutclick&&a._attachEvent(a.$modal.$modalbackground,"click",function(){a.hide()})):a.$modal.$modalbox.appendTo(c("body"));a.options.closable||a.setClosable(!1)},_attachEvent:function(a,b,c){var e=this;a&&b&&c&&(a.off(b),a.on(b,function(a){a.stopPropagation();c.call(e)}))},setTitle:function(a){this.$modal.$modaltitle.text(a)},setMessage:function(a){this.$modal.$modalmessage.text(a)},setMessageExplain:function(a){this.$modal.$modalmorebox.text(a)},
setMoreinfoState:function(a){var b=this;a?(b.$modal.$modalmorelbtn.css({display:"inline-block"}),b._attachEvent(b.$modal.$modalmorelbtn,"click",function(){b.$modal.$modalmorebox.slideToggle()})):b.$modal.$modalmorelbtn.hide()},setMoreinfoButtonText:function(a){a&&this.$modal.$modalmorelbtn.text(a)},setStyle:function(a){var b=this.$modal.$modalbox.attr("class");this.$modal.$modalbox.addClass(a).removeClass(b)},setClosable:function(a){var b=this;!0===a?(b.$modal.$closebutton.show(),b._attachEvent(b.$modal.$modalbackground,
"click",function(){b.$modal.$modalbackground.hide()})):(b.$modal.$closebutton.hide(),b.$modal.$modalbackground.off("click"))},show:function(){this.$modal.$modalbackground.show()},hide:function(){this.$modal.$modalbackground.hide();this.$modal.$modalmorebox.hide()},setButtons:function(a){c.extend(!0,this.options.buttons,a);this._buildButtons()},constructor:function(){var a=this;a._buildModal();a._buildButtons();a._attachEvent(a.$modal.$closebutton,"click",function(){a.hide()})}}})(window,jQuery);