...
this;!0===a?(b.$modal.$closebutton.show(),b._attachEvent(b.$modal.$modalbackground,"click",function(){b.$modal.$modalbackground.hide()})):(b.$modal.$closebutton.hide(),b.$modal.$modalbackground.off("click"))},show:function(){this.$modal.$modalbackground.show()},hide:function(){this.$modal.$modalbackground.hide();this.$modal.$modalmorebox.hide()},setButtons:function(a){c.extend(!0,this.options.buttons,a);this._buildButtons()},constructor:function(){var a=this;a._buildModal();a._buildButtons();a._attachEvent(a.$modal.$closebutton,
"click",function(){a.hide()})}}})(window,jQuery);